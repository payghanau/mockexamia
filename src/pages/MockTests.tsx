  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 pt-24 pb-16 px-4">
        ...
        <div className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12">Choose Your Exam Category</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* NISM Card */}
              <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                <CardHeader className="pb-2">
                  <div className="h-12 w-12 rounded-lg bg-blue-100 flex items-center justify-center mb-4">
                    <BookOpen className="h-6 w-6 text-blue-600" />
                  </div>
                  <CardTitle className="text-2xl text-blue-800">NISM Mock Tests</CardTitle>
              ...
              {/* GATE Card */}
              <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                <CardHeader className="pb-2">
                  <div className="h-12 w-12 rounded-lg bg-purple-100 flex items-center justify-center mb-4">
                    <GraduationCap className="h-6 w-6 text-purple-600" />
                  </div>
                  <CardTitle className="text-2xl text-purple-800">GATE Mock Tests</CardTitle>
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm text-purple-700">
                    <li className="flex items-start">
                      <div className="w-1.5 h-1.5 bg-purple-500 rounded-full mr-2 mt-1.5 flex-shrink-0"></div>
              ...
              {/* Other Exams Card */}
              <Card className="overflow-hidden transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                <CardHeader className="pb-2">
                  <div className="h-12 w-12 rounded-lg bg-green-100 flex items-center justify-center mb-4">
                    <Clock className="h-6 w-6 text-green-600" />
                  </div>
                  <CardTitle className="text-2xl text-green-800">Other Exam Tests</CardTitle>
                ...
                <CardFooter>
                  <Button disabled className="mt-4 w-full bg-green-600 hover:bg-green-700 opacity-70 cursor-not-allowed">
        ...
        <div className="py-16 px-4 bg-gray-50">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-12">Why Choose Our Mock Tests?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-xl font-semibold mb-2">Realistic Exam Simulation</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-xl font-semibold mb-2">Detailed Performance Analysis</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-xl font-semibold mb-2">Customizable Practice</h3>
                <p className="text-gray-600">
