...
const GoogleAuth = ({ type }: GoogleAuthProps) => {
  ...
  return (
    <Button
      variant="outline"
      type="button"
      className="w-full bg-white hover:bg-mcq-gray-lightest flex items-center justify-center"
      onClick={handleGoogleAuth}
      disabled={isLoading}
    >
      {isLoading ? (
        <div className="flex items-center justify-center">
          <div className="animate-spin mr-2 h-4 w-4 border-2 border-mcq-blue border-t-transparent rounded-full" />
